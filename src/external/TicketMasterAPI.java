...
public class TicketMasterAPI {
	private static final String URL = "https://app.ticketmaster.com/discovery/v2/events.json";//创建url,不变
	private static final String DEFAULT_KEYWORD = ""; // no restriction
	private static final String API_KEY = "xIO1qAFh1GVHmOVNO3w4xGGBCvGL93qt";//APIkey 在变
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// "apikey=qqPuP6n3ivMUoT9fPgLepkRMreBcbrjV&latlong=37,-120&keyword=event&radius=50"//浏览器给的啥就是啥
		...
		try {
			...
			int responseCode = connection.getResponseCode();//没有调用
			System.out.println("Sending request to url: " + url);//调用两次，第一次是http requese
			...
			if (!obj.isNull("_embedded")) {  //APIKEY藏起来在此
